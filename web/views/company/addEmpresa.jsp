        ...
        <div class="col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="/SavPro/AddCompany" method="POST" class="needs-validation" novalidate>
                        <div class="form-row">



                            <div class="col-md-6 mb-3">
                                <label for="validationCustom01">Nombre Empresa:</label>
                                <input name="nombre" type="text" class="form-control" id="validationCustom01" maxlength="30" placeholder="My company" pattern="[A-Za-z]{3+}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="nit" type="text" class="form-control" id="validationCustom02" maxlength="30" placeholder="Nit Empresa" pattern=".{6,}" required>
                                <div class="valid-feedback">
                                    Correcto
                                </div>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="direccion" type="text" class="form-control" id="validationCustom01" maxlength="50" placeholder="Calle #" pattern="[A-Za-z]{3+}" required>
                                <div class="valid-feedback">
                                    Correcto
                                </div>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="telefono" type="text" class="form-control" id="validationCustom04" maxlength="30" placeholder="telefono" required>
                                <div class="valid-feedback">
                                    Correcto
                                </div>
                                <div class="invalid-feedback">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3 mb-3">
                                ...
                                <div class="invalid-feedback">
                                    ...
                                    <c:otherwise>
                                        <select name="usuario" type="hidden" class="form-control" id="exampleFormControlSelect1" tabindex="4" style="visibility:hidden">
                                  
                                    
                                        <option value="${USER.idUsuario}"></option>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="sector" type="text" class="form-control" id="validationCustom03" maxlength="50" placeholder="Sector de la empresa" required>
                                <div class="valid-feedback">
                                    Correcto
                                </div>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="page" type="text" class="form-control" id="validationCustom03" maxlength="100" placeholder="www.mycompany.co" required>
                                <div class="valid-feedback">
                                    Correcto
                                </div>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="razon" type="text" class="form-control" id="validationCustom03" maxlength="100" placeholder="razón social empresa" required>
                                <div class="valid-feedback">
                                    Correcto
                                </div>
                                <div class="invalid-feedback">
